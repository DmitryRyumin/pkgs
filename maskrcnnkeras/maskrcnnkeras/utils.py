...
"""
Служебные функции и классы Mask R-CNN
"""
...
# ######################################################################################################################
# Вычисление ограничивающей рамки из маски
def extract_bboxes(mask):
    ...
    for i in range(mask.shape[-1]):
        ...
        if horizontal_indicies.shape[0]:
            ...
            # Увеличение x2 и y2 на 1, чтобы они не были частью рамки
            x2 += 1
            y2 += 1
        else:
            # Нет маски для экземпляра. Может произойти из-за изменения размера или обрезки
            x1, x2, y1, y2 = 0, 0, 0, 0
